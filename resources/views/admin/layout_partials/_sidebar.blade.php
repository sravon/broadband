    ...
    <ul class="lisst-unstyled components">
      ...
      <li class="{{ (request()->is('admin/accounts')) ? 'active' : '' }}">
        ...
        <li class="{{ (request()->is('admin/pays')) ? 'active' : '' }}">
            <a href="{{ route('pays.index') }}"><i class="fa fa-money"></i>Pay Bill</a>
        </li>
        ...
        <li class="{{ (request()->is('admin/settings')) ? 'active' : '' }}">
            <a href="{{ route('settings.index') }}"><i class="fa fa-cog"></i>Setting</a>
        </li>
        <li class="{{ (request()->is('admin/pages')) ? 'active' : '' }}" style="position: relative;">
            <a type="button" id="page"><i class="fa fa-pagelines"></i>Pages</a>
