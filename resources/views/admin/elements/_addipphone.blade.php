<div class="col-md-4">
    ...
    <form action="{{ route('iphones.store') }}" enctype="multipart/form-data" class="p-3 border border-3" method="post">
      @csrf
      <x-input name="name" label="Name" place="Enter Name"/>
      <x-input name="image" label="Image" datatype="file"/>
